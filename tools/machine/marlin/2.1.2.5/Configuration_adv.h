...
#define HOMING_BUMP_MM      { 40, 5, 5 }      // (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 32, 4, 4 }      // Re-Bump Speed Divisor (Divides the Homing Feedrate)
