...
export default function ({ instructions, step, showArrow, showNails, showNumber, highlightLast, strokeWidth, nailOffset }: Options) {
    ...
    return (
        ...
        >
            ...
            {
                Array.from(Array(step + 1).keys()).map((i: number) => (
                    <line
                        key={`line_${i}`}
                        {...getPosition(i)}
                        stroke="black" 
            ...
            <g>
                ...
                {dstNail && showArrow && <path
                    ...
                    d={
                        instructions.steps[step].direction == RotationDirection.ClockWise
